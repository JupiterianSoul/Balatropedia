/* @ts-self-types="./balatro_seed_engine.d.ts" */
 ...
 * @returns {Uint8Array}
 */
export function scan_chunk(filter_json, start_rank, count, seed_len, deck_idx, stake_idx, partial, min_score) {
    const ptr0 = passStringToWasm0(filter_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.scan_chunk(ptr0, len0, start_rank, count, seed_len, deck_idx, stake_idx, partial, min_score);
 ...
 * @returns {Uint8Array}
 */
export function scan_chunk_parallel(filter_json, start_rank, count, seed_len, deck_idx, stake_idx, partial, min_score) {
    const ptr0 = passStringToWasm0(filter_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.scan_chunk_parallel(ptr0, len0, start_rank, count, seed_len, deck_idx, stake_idx, partial, min_score);
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v2;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./balatro_seed_engine_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('balatro_seed_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
